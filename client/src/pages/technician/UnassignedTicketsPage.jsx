...
function UnassignedQueue() {
  ...
  useEffect(() => {
    ...
    getUnassignedTickets({ page: request.page, limit: 10, signal: controller.signal }).then(data => {
  ...
  return <div className="space-y-6">
    ...
    {!current && <p role="status">Loading unassigned tickets...</p>}
    ...
    {current?.data && <>
      ...
      <UnassignedTicketsList tickets={current.data.tickets} totalRecords={current.data.pagination.totalRecords} />
...
export function UnassignedTicketsList({ tickets, totalRecords }) {
