...
export default function TechnicianManagementPage() {
  ...
  return <div className="space-y-5">
    <header className="flex flex-wrap items-start justify-between gap-4"><div><h1 className="text-2xl font-semibold">Technician Management</h1><p className="mt-2 text-slate-600">View technician accounts and current active ticket counts.</p></div><Link className={`${button} shrink-0 hover:bg-teal-50`} to="/admin/users">Manage user accounts</Link></header>
