...
function MyTickets() {
  ...
  useEffect(() => {
    ...
    getMyTickets({ page: request.page, signal: controller.signal }).then(data => {
  ...
  return <div className="space-y-6">
    ...
    {!current && <p role="status" className="text-sm text-slate-600">Loading tickets...</p>}
    ...
    {current?.data && <>
      <MyTicketsList tickets={current.data.tickets} totalRecords={current.data.pagination.totalRecords} />
