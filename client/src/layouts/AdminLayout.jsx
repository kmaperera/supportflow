...
export default function AdminLayout() {
  ...
  const page = location.pathname === '/admin/users/new' ? { title: 'Create User' } : adminNavigation.find(item => matchPath({ path: item.path, end: true }, location.pathname))
